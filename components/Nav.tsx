    ...
    <nav className={`sticky top-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white/90 backdrop-blur-md shadow-tiny py-3' : 'bg-white border-b py-4'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-1.5">
          ...
          {user && (
            <>
              <Link href="/messages" className="px-3.5 py-2 rounded-tiny-sm text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-charcoal transition-colors flex items-center gap-2">
        ...
        <div className="flex items-center gap-3">
          {user ? (
            <div className="flex items-center gap-3">
              ...
              <Link href="/profile" className="flex items-center gap-2 bg-gray-100 px-3 py-1.5 rounded-tiny shadow-tiny-sm cursor-pointer hover:bg-gray-200 transition-colors group/profile">
